        ...
        <div class="heroGrid">
          ...
          <div class="heroText">
            ...
            <div class="actions">
              ...
              <a class="btn" href="#spiritualAudiosSection">🎧 صوت‌ها</a>
...
واحد فرهنگی بنیاد شهید رامهرمز
        ...
        <!-- 5) صوت‌ها -->
        <section class="niyat" id="spiritualAudiosSection">
          <h3>🎧 صوت‌های معنوی</h3>
          <div class="text" style="margin-top:6px; font-size:12px; color:var(--muted);">
...
برای ویرایش نوشته‌ی خودتان، «کلید ویرایش» را نگه دارید.
  ...
  <nav class="dock" aria-label="دسترسی سریع">
    ...
    <a href="#notes" data-open="notes">💌 دل‌نوشته</a>
